...
class VocalExerciseCategoryDetailScreen extends StatefulWidget {
  final VocalCategory category;

  const VocalExerciseCategoryDetailScreen({
    super.key,
    required this.category,
  });

  @override
  State<VocalExerciseCategoryDetailScreen> createState() => _VocalExerciseCategoryDetailScreenState();
}

class _VocalExerciseCategoryDetailScreenState extends State<VocalExerciseCategoryDetailScreen> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'This category doesn\'t have any vocal exercises yet.',
              style: TextStyle(
                color: AppTheme.textMuted,
                fontSize: 14,
                fontFamily: AppTheme.primaryFontFamily,
